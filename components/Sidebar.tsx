...
import { DashboardIcon, WrenchScrewdriverIcon, ArchiveBoxIcon, UsersIcon, SparklesIcon, ShoppingCartIcon, UserGroupIcon, Cog6ToothIcon, ChartBarIcon, DocumentChartBarIcon, XMarkIcon, ArrowRightEndOnRectangleIcon, PlusIcon, TrashIcon, BuildingLibraryIcon, SunIcon, MoonIcon, ComputerDesktopIcon, ChartPieIcon, RectangleGroupIcon } from './common/Icons';
...
const Sidebar: React.FC<SidebarProps> = ({ currentUser, users, departments, setCurrentUser, storeSettings, setStoreSettings, isOpen, setIsOpen, onLogout, onSwitchApp, currentBranchId, setCurrentBranchId, theme, setTheme }) => {
